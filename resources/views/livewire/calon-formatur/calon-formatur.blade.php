<div>
    ...
    <div class="px-4 pt-6">
        <div
            ...
            <div class="w-full mb-1 h-[calc(100dvh-80px)]">
                <div class="">
                    ...
                    @if ($isOpen)
                        @include('livewire.calon-formatur.create')
                    @endif
                                    ...
                                    <thead
                                        ...
                                        <tr>
                                            <th scope="col" class="w-2/12 px-4 py-3">
                                                ...
                                                @else
                                                    <x-sort-link :active=false wire:click.prevent="sortBy('no_urut')"
                                                        role="button" href="#">
                                                        No Urut
                                                    </x-sort-link>
                                                @endif
                                            ...
                                            <tr class="border-b group dark:border-gray-700">
                                                ...
                                                <td
                                                    ...
                                                    <div>
                                                        ...
                                                        <div id="dropdownMenu{{ $cF->no_urut }}"
                                                            class="z-10 hidden w-auto bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700">
                                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                                aria-labelledby="dropdownButton{{ $cF->no_urut }}">
                                                                <li>
                                                                    <x-dropdown-link
                                                                        wire:click="tampil('{{ $cF->no_urut }}')">
                                                                        {{ __('Tampil | ' . $cF->nama) }}
                                                                    </x-dropdown-link>
                                                                </li>
                                                                <li>
                                                                    <x-dropdown-link
                                                                        wire:click="edit('{{ $cF->no_urut }}')">
                                                                        {{ __('Ubah') }}
                                                                    </x-dropdown-link>
                                                                </li>
                                                                <li>
                                                                    <x-dropdown-link
                                                                        wire:click="$emit('confirm_remove_record', '{{ $cF->no_urut }}', '{{ $cF->nama }}')">
                                                                        {{ __('Hapus') }}
                                                                    </x-dropdown-link>
                                                                </li>
